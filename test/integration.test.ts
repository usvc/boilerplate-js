  ...
  context('.server', () => {
    ...
    context('metrics', () => {
      ...
      it('works', () => {
        ...
        expect(text).to.contain('http_request_duration_seconds_sum');
        expect(text).to.contain('http_request_duration_seconds_count');
        expect(text).to.contain('http_request_duration_seconds_bucket');
      });
    });
    // context: metrics
